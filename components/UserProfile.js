      ...
      <ScrollView showsVerticalScrollIndicator ={false}>
        <View style={styles.detailsBar}>
            ...
            <View style={styles.edit}>
                ...
                {
              showDiscoverPeople
              ? <Ionicons name="person-add" size={24} color="black" onPress={changeShowDiscoverPeople}/>
              : <Ionicons name="person-add-outline" size={24} color="black" onPress={changeShowDiscoverPeople}/>
              }
            </View>
            {
              showDiscoverPeople
